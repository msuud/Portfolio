  ...
  return (
    <AboutContainer id="about">
      <ContentWrapper>
        ...
        <SectionSubtitle>
          My journey, my mission, and my passions.
        </SectionSubtitle>
        <TimelineContainer>
          {aboutData.map((item, index) => (
            ...
            >
              <TimelineContent>
                ...
                <AboutParagraph>{item.text}</AboutParagraph>
              </TimelineContent>
            </TimelineItem>
          ))}
        </TimelineContainer>
